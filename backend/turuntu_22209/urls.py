"""turuntu_22209 URL Configuration
...
admin.site.site_header = "TURUNTU"
admin.site.site_title = "TURUNTU Admin Portal"
admin.site.index_title = "TURUNTU Admin"

# swagger
api_info = openapi.Info(
    title="TURUNTU API",
    default_version="v1",
    description="API documentation for TURUNTU App",
)
